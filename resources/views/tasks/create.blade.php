    ...
    <div style="max-width: 700px; margin: 0 auto;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
            <h1 style="color: #14213d; font-size: 1.8rem; font-weight: 700;">
                <i class="fas fa-plus-circle" style="color: #3f6bf0;"></i>
                Tambah Task
            </h1>
            ...
            <form method="POST" action="{{ route('tasks.store') }}">
                ...
                <div style="margin-bottom: 1.5rem;">
                    ...
                    <textarea id="description" name="description" 
                              ...
                              rows="4"
                              style="width: 100%; padding: 0.75rem 1rem; border: 1.5px solid #e2e8f0; border-radius: 12px; font-size: 1rem; font-family: inherit; resize: vertical;">{{ old('description') }}</textarea>
                    @error('description')
                        <span style="color: #dc2626; font-size: 0.85rem; margin-top: 0.25rem; display: block;">{{ $message }}</span>
                    @enderror
                </div>
